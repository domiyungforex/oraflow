...
async function main() {
  ...
  // Create 20 products
  const productData = [
    { name: "Malta Guinness 50cl", slug: "malta-guinness-50cl", sku: "MGU-50CL", price: 2500, cost: 1800, unit: "carton", aliases: ["malt", "malta", "guinness", "guiness"], categoryId: categories[0].id },
    { name: "Malta Guinness 33cl", slug: "malta-guinness-33cl", sku: "MGU-33CL", price: 1800, cost: 1200, unit: "carton", aliases: ["small malt"], categoryId: categories[0].id },
    { name: "Coca-Cola 50cl", slug: "coca-cola-50cl", sku: "CCL-50CL", price: 2200, cost: 1500, unit: "carton", aliases: ["coke", "cola", "coca cola"], categoryId: categories[0].id },
    { name: "Fanta 50cl", slug: "fanta-50cl", sku: "FNT-50CL", price: 2200, cost: 1500, unit: "carton", aliases: ["fanta"], categoryId: categories[0].id },
    { name: "Premium Rice 50kg", slug: "premium-rice-50kg", sku: "RCE-50KG", price: 95000, cost: 78000, unit: "bag", aliases: ["rice", "ariba", "ofada"], categoryId: categories[1].id },
    { name: "Local Rice 50kg", slug: "local-rice-50kg", sku: "LRCE-50KG", price: 65000, cost: 52000, unit: "bag", aliases: ["local rice", "本土米"], categoryId: categories[1].id },
    { name: "Garri 50kg", slug: "garri-50kg", sku: "GRR-50KG", price: 35000, cost: 28000, unit: "bag", aliases: ["garri", "gari", "cassava"], categoryId: categories[1].id },
    { name: "Semolina 50kg", slug: "semolina-50kg", sku: "SML-50KG", price: 42000, cost: 34000, unit: "bag", aliases: ["semolina", "semovita"], categoryId: categories[1].id },
    { name: "Vegetable Oil 20L", slug: "vegetable-oil-20l", sku: "VOIL-20L", price: 48000, cost: 38000, unit: "keg", aliases: ["oil", "vegetable oil", "cooking oil"], categoryId: categories[2].id },
    { name: "Palm Oil 20L", slug: "palm-oil-20l", sku: "POIL-20L", price: 52000, cost: 42000, unit: "keg", aliases: ["palm oil", "red oil"], categoryId: categories[2].id },
    { name: "Tomato Paste 400g", slug: "tomato-paste-400g", sku: "TMP-400G", price: 1200, cost: 700, unit: "tin", aliases: ["tomato", "tomatoe", "paste"], categoryId: categories[2].id },
    { name: "Indomie Noodles 70g", slug: "indomie-noodles-70g", sku: "IND-70G", price: 200, cost: 130, unit: "pack", aliases: ["indomie", "noodles", "instant noodles"], categoryId: categories[2].id },
    { name: "Indomie Noodles Carton (40 packs)", slug: "indomie-carton", sku: "IND-CTN", price: 7500, cost: 5800, unit: "carton", aliases: ["indomie carton", "noodles carton"], categoryId: categories[2].id },
    { name: "Milk Powder 900g", slug: "milk-powder-900g", sku: "MLK-900G", price: 5500, cost: 4200, unit: "tin", aliases: ["milk", "powdered milk", "peak milk"], categoryId: categories[3].id },
    { name: "Eggs (crate of 30)", slug: "eggs-crate-30", sku: "EGG-CRT", price: 4500, cost: 3600, unit: "crate", aliases: ["eggs", "egg", "crate of eggs"], categoryId: categories[3].id },
    { name: "Dano Milk 50cl", slug: "dano-milk-50cl", sku: "DNO-50CL", price: 800, cost: 550, unit: "pack", aliases: ["dano", "dano milk"], categoryId: categories[3].id },
    { name: "Chin Chin 1kg", slug: "chin-chin-1kg", sku: "CHC-1KG", price: 3500, cost: 2200, unit: "pack", aliases: ["chin chin", "chinchin"], categoryId: categories[4].id },
    { name: "Plantain Chips 500g", slug: "plantain-chips-500g", sku: "PLC-500G", price: 2800, cost: 1800, unit: "pack", aliases: ["plantain chips", "kelewele chips"], categoryId: categories[4].id },
    { name: "Biscuit Assorted 1kg", slug: "biscuit-assorted-1kg", sku: "BSC-1KG", price: 4200, cost: 3100, unit: "pack", aliases: ["biscuit", "biscuits", "cookies"], categoryId: categories[4].id },
    { name: "Table Water 75cl (pack of 12)", slug: "table-water-75cl", sku: "WTR-75CL", price: 2000, cost: 1400, unit: "pack", aliases: ["water", "bottled water", "pure water"], categoryId: categories[0].id },
  ];
